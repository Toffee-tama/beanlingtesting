...
@include('widgets._loot_select_row', ['items' => $items, 'currencies' => $currencies, 'tables' => $tables, 'Recipe' => $recipes, 'raffles' => $raffles, 'showLootTables' => true, 'showRaffles' => true, 'showRecipes' => true])
